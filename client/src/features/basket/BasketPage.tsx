...
export default function BasketPage(){
    ...
    //getting the basket from the redux store
            ...
            >
              <TableCell component="th" scope="row">
                <Box display='flex' alignItems='center'>
                    <img src={item.pictureUrl} alt={item.pictureUrl} style={{height:50, marginRight:20}}/>
                    <span>{item.name}</span>
                </Box>
              </TableCell>
    ...
    <Grid container>
        ...
        <Button variant="contained" fullWidth href="/checkout">checkout</Button>
